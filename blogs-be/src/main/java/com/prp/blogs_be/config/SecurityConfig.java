package com.prp.blogs_be.config;

import com.prp.blogs_be.domain.entities.User;
import com.prp.blogs_be.repositories.UserRepository;
import com.prp.blogs_be.security.BlogUserDetailsService;
import com.prp.blogs_be.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(
	...
	http.authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.POST, "/api/v1/auth/login")
										   .permitAll()
